...
# Need to get this directly from the user input
keywords = ["Rice University",
            "POST Houston",
            "NRG Stadium"]
...
for point_of_interest in keywords:
    ...
    if response.status_code == 200:
        ...
        for result in data['resourceSets'][0]['resources'][0]['value']:
            ...
            print()
        print(f"Your entry: {point_of_interest}")
        print(f"Possible Addresses: {addresses}")
    else:
